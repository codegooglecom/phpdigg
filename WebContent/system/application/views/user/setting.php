<?php echo css('css/user-setting.css'); ?>
...
<div class="g-tab-panel-content">
	...
	<div id="detail-info-panel" class="g-panel g-tab-content">
		<div class="bd">
			<form id="detail-info-form" action="user/profile" method="post">
			<?php echo form_open('user/profile', array( 'id' => 'detail-info-form')); ?>
				<div class="form-field">
