...
//	public static $db_user 		= "phpMoney";
	...
	public static $db_data_source_template 	= "mysql:dbname=%s;host=%s;charset=%s";

	public static function getDateSourceName() {
		$dsn = sprintf(self::$db_data_source_template, self::$db_name, self::$db_host, self::$db_charset);
		return $dsn;
	}
