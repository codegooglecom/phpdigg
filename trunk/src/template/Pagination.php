...
if ($i > 5) {
?>
	<a href="default.php?page=<?php echo $i - 5; ?>">上五页</a>
<?php
}

if ($previousPage > 0) {
?>
	<a href="default.php?page=<?php echo $page - 1; ?>">上一页</a>
<?php
} else {
?>
...
if ($i < $totalPage + 1) {
?>
<a href="default.php?page=<?php echo $page + 1; ?>">下一页</a>
<a href="default.php?page=<?php echo $i; ?>">下五页</a>
<?php
} else {
?>
